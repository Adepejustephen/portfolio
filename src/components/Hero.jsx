    ...
    <section className="flex flex-col w-full h-full lg:flex-row lg:justify-between lg:items-center m-auto max-w-6.5xl px-10 md:px-14 xl:px-0 py-10 md:gap-14 min-h-screen xxl:max-w-xbs">
      <div className="flex flex-col gap-6 text-center lg:text-left">
        ...
        <div className="flex gap-5 justify-center lg:justify-start w-full">
          <button className=" flex items-center justify-center w-full p-2 bg-orange text-white rounded-lg hover:bg-transparent hover:border-orange hover:text-orange hover:border md:w-[10.5rem] font-bold h-[3.8125rem] ">
            Hire me
          </button>
            <button className="flex items-center justify-center w-full  p-2 text-orange rounded-lg hover:bg-[#1d1c1c333]  border hover:text-white border-orange md:w-[10.5rem] font-bold h-[3.8125rem]">
          <a href="/">
